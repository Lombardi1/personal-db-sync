...
import { ModalAnagraficaForm } => '@/components/modals/ModalAnagraficaForm';
import {
  Table,
  TableBody,
  TableCell,
          ...
          <Table className="min-w-full table-auto">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-xs sm:text-sm min-w-[60px] whitespace-normal">Tipo Fornitore</TableHead>
                <TableHead className="text-xs sm:text-sm min-w-[70px] whitespace-normal">P.IVA / Cod. Fiscale</TableHead>
                <TableHead className="text-xs sm:text-sm min-w-[50px] whitespace-normal">Città</TableHead>
                <TableHead className="text-xs sm:text-sm min-w-[60px]">Telefono</TableHead>
                ...
                <TableHead className="text-xs sm:text-sm min-w-[80px] whitespace-normal">Banca</TableHead>
            ...
            <TableBody>
              {fornitoriFiltered.map((fornitore) => (
                <TableRow key={fornitore.id}>
                  ...
                  <TableCell className="text-xs sm:text-sm min-w-[60px] whitespace-normal">{fornitore.tipo_fornitore || '-'}</TableCell>
                  <TableCell className="text-xs sm:text-sm min-w-[70px] whitespace-normal">{fornitore.partita_iva || fornitore.codice_fiscale || '-'}</TableCell>
                  <TableCell className="text-xs sm:text-sm min-w-[50px] whitespace-normal">{fornitore.citta || '-'}</TableCell>
                  <TableCell className="text-xs sm:text-sm min-w-[60px] whitespace-normal">{fornitore.telefono || '-'}</TableCell>
                  <TableCell className="text-xs sm:text-sm min-w-[80px] whitespace-normal">{fornitore.email || '-'}</TableCell>
                  ...
                  <TableCell className="text-xs sm:text-sm min-w-[80px] whitespace-normal">{fornitore.banca || '-'}</TableCell>
