...
export function GiacenzaTab({ giacenza, scaricoFogli, riportaInOrdini, storico }: GiacenzaTabProps) {
  ...
  return (
    <div>
      ...
      <h2 className="text-xl sm:text-2xl font-bold text-[hsl(var(--primary))] mb-4 sm:mb-5 flex items-center gap-2">
      ...
      <div className="mb-3 flex flex-wrap gap-2">
        <Button
          ...
          className="bg-[hsl(217,91%,88%)] text-[hsl(var(--primary-dark))] hover:bg-[hsl(217,91%,78%)] text-sm py-2 px-3"
        >
          <i className="fas fa-file-excel mr-1 sm:mr-2"></i> <span className="hidden sm:inline">Esporta</span> XLS
        </Button>
        <Button
          onClick={() => esportaTabellaPDF('tab-dashboard', 'giacenza.pdf', 'giacenza')}
          className="bg-[hsl(217,91%,88%)] text-[hsl(var(--primary-dark))] hover:bg-[hsl(217,91%,78%)] text-sm py-2 px-3"
        >
