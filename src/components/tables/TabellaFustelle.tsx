        ...
        <table id="tab-fustelle" className="w-full border-collapse text-xs table-auto">
          <thead>
            <tr className="bg-[hsl(210,40%,98%)] border-b-2 border-[hsl(var(--border))]">
              ...
              <th className="px-2 py-2 text-left text-[10px] sm:text-xs font-semibold min-w-[80px]">Codice Pulitore</th>
          ...
          <tbody>
            {fustelle.map((fustella) => (
              <tr key={fustella.codice} className="border-b border-[hsl(var(--border))] hover:bg-[hsl(210,40%,98%)] transition-colors">
                ...
                <td className="px-2 py-1.5 text-[10px] sm:text-xs whitespace-nowrap">{fustella.pulitore_codice || '-'}</td>
                ...
                {!isVisualizzatore && (
                  <td className="px-2 py-1.5 text-right">
                    <div className="flex justify-end gap-1">
                      <Button variant="outline" size="icon" onClick={() => onEdit(fustella)} className="h-7 w-7 sm:h-8 sm:w-8" title="Modifica Fustella">
                      ...
                      <Button variant="destructive" size="icon" onClick={() => onDelete(fustella.codice)} className="h-7 w-7 sm:h-8 sm:w-8" title="Elimina Fustella">
