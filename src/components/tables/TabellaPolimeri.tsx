        ...
        <table id="tab-polimeri" className="w-full border-collapse text-xs table-auto">
          <thead>
            <tr className="bg-[hsl(210,40%,98%)] border-b-2 border-[hsl(var(--border))]">
              ...
              <th className="px-2 py-2 text-left text-[10px] sm:text-xs font-semibold min-w-[100px]">Nr. Fustella</th>
              ...
              {!isVisualizzatore && <th className="px-2 py-2 text-right text-[10px] sm:text-xs font-semibold min-w-[100px]">Azioni</th>}
            </tr>
          </thead>
          <tbody>
                ...
                {!isVisualizzatore && (
                  <td className="px-2 py-1.5 text-right">
                    <div className="flex justify-end gap-1">
                      <Button variant="outline" size="icon" onClick={() => onEdit(polimero)} className="h-7 w-7 sm:h-8 sm:w-8" title="Modifica Polimero">
                        <Edit className="h-3 w-3 sm:h-4 sm:w-4" />
                      </Button>
                      <Button variant="outline" size="icon" onClick={() => onChangeDisponibilita(polimero.codice, !polimero.disponibile)}
                      ...
                      <Button variant="destructive" size="icon" onClick={() => onDelete(polimero.codice)} className="h-7 w-7 sm:h-8 sm:w-8" title="Elimina Polimero">
