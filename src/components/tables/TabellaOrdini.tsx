        ...
        <table id="tab-ordini" className="w-full border-collapse table-auto">
          <thead>
            <tr className="bg-[hsl(210,40%,98%)] border-b-2 border-[hsl(var(--border))]">
              ...
              <th className="px-3 py-3 text-left text-[10px] sm:text-sm font-semibold w-[100px]">Data Arrivo</th>
          ...
          <tbody id="ordini-body">
            {ordini.map((ordine) => (
              ...
              >
                ...
                <td className="px-3 py-2 text-[10px] sm:text-sm whitespace-nowrap w-[80px]">{ordine.ddt || '-'}</td>
                ...
                <td className="px-3 py-2 text-[10px] sm:text-sm whitespace-nowrap w-[100px]">{formatData(ordine.data_arrivo || '')}</td>
