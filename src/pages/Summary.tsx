        ...
        {user.role === 'amministratore' && (
          <div className="grid grid-cols-1 gap-8 w-full">
            ...
            <div className="col-span-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <Button
                onClick={() => navigate('/produzione-dashboard')}
                size="lg" 
                className="bg-[hsl(var(--produzione-color))] hover:bg-[hsl(var(--produzione-color-dark))] text-white rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-3 sm:gap-4 text-sm sm:text-base py-3 sm:py-4 h-auto text-center"
              >
              ...
              <Button
                ...
                size="lg"
                className="bg-[hsl(var(--colori-color-dark))] hover:bg-[hsl(330,80%,28%)] text-white rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-3 sm:gap-4 text-sm sm:text-base py-3 sm:py-4 h-auto text-center"
              >
