 ...
 *
 * DATABASE: usa la tabella db_articoli esistente (migrazione giÃ  applicata).
 * STORAGE:  bucket 'schede-tecniche' (giÃ  creato).
 */

import { useState, useEffect, useCallback, useRef } from 'react'
import { supabase } from '../lib/supabaseClient' // â adatta il path
...
// âââ MAPPING: db_articoli â FormData âââââââââââââââââââââââââââââââââââââââââ
