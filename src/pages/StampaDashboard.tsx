...
import { MinusCircle, History, Palette, Calculator, FileText, Database, Printer, Factory , Tag } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[hsl(210,40%,96%)]">
      ...
      <div className="mx-auto p-3 sm:p-5 md:px-8 flex flex-col items-center justify-center pt-16 min-h-[calc(100vh-120px)] max-w-3xl">
        ...
        <p className="text-base sm:text-lg text-[hsl(var(--muted-foreground))] mb-6 sm:mb-8 text-center">{currentDateTime}</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full sm:w-3/4 md:w-3/4 mx-auto">

          {/* NUOVO: Accesso macchine produzione */}
          <Button onClick={() => navigate('/selezione-macchina')} size="lg"
            className="col-span-1 sm:col-span-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 h-20 sm:h-24 px-8 sm:px-12 border-2 border-blue-400">
            <Factory className="h-6 w-6 sm:h-8 sm:w-8 text-white flex-shrink-0" />
            <span className="leading-none text-sm sm:text-base whitespace-nowrap font-bold">Produzione — Vai alla macchina</span>
          </Button>

          <Button onClick={() => navigate('/scarico-magazzino-stampa')} size="lg"
          ...
          <Button onClick={() => navigate('/storico-stampa')} size="lg"
          ...
          <Button onClick={() => navigate('/consumo-colore')} size="lg"
          ...
          <Button onClick={() => navigate('/consumo-colore?tab=colori-calcolo')} size="lg"
          ...
          <Button onClick={() => navigate('/lavori-stampa')} size="lg"
          ...
          <Button onClick={() => navigate('/db-articoli-produzione')} size="lg"
          ...
          <Button onClick={() => navigate('/genera-documenti')} size="lg"
          ...
          <Button onClick={() => navigate('/sscc-labels')} size="lg"
            className="bg-amber-600 hover:bg-amber-700 text-white rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 h-20 sm:h-24 px-8 sm:px-12">
            <Tag className="h-6 w-6 sm:h-8 sm:w-8 text-white flex-shrink-0" />
            <span className="leading-none text-sm sm:text-base whitespace-nowrap">Etichette SSCC GS1</span>
          </Button>
        </div>
      </div>
    </div>
