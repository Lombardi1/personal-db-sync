      ...
      <div className="mx-auto p-3 sm:p-5 md:px-8 flex flex-col items-center justify-center pt-16 min-h-[calc(100vh-120px)] max-w-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full sm:w-3/4 md:w-3/4 mx-auto">
          ...
          <Button
            ...
            size="lg"
            className="bg-[hsl(var(--colori-color))] hover:bg-[hsl(var(--colori-color-dark))] text-white rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 h-20 sm:h-24 px-8 sm:px-12 col-span-1 sm:col-span-2"
          >
